...
gamepad fisik, lalu dikirim ke PC lewat WiFi sebagai satu virtual Xbox 360
controller.
...
```
gyropad/
├── android/     # Aplikasi Android (Kotlin) - baca gamepad + gyro, kirim ke PC
├── pc/          # Server PC (Python) - terima data, emulasi virtual Xbox controller
└── docs/        # Dokumentasi
```
...
3. Pastikan HP & PC ada di jaringan WiFi yang sama.
4. Pairing gamepad iPega 9076 ke HP lewat Bluetooth seperti biasa.
5. Buka app GyroPad, isi IP PC, tekan **Hubungkan**.
6. Tahan L1 di gamepad untuk aktifkan gyro-aim sementara membidik.

## Format data (protocol)

Detail lengkap paket JSON yang dikirim HP -> PC ada di
[docs/PROTOCOL.md](docs/PROTOCOL.md).

## Roadmap / ide pengembangan

- [ ] Ganti JSON dengan format biner supaya latency lebih rendah
- [ ] Kalibrasi & auto-recenter gyro
- [ ] Opsi kirim lewat ADB (USB) sebagai alternatif WiFi
